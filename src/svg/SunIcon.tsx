...
export const SunIcon: FC<SvgIconPropsType> = (props) => {
    return (
        <svg
            width="24"
            height="24"
            ...
            <path
                ...
                strokeLinecap="round"
            />
            <path d="M19 12L21 12" stroke="white" strokeWidth="2" strokeLinecap="round" />
            <path d="M3 12L5 12" stroke="white" strokeWidth="2" strokeLinecap="round" />
            <path
